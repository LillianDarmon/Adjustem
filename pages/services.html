...
<head>
    ...
    <title>Adjustem - Solution de devis menuiseries - services</title>
</head>
<body class="overlay">
<div id="tt">
...
<CENTER>    
    <p  id="p_title">Les services proposés par Adjustem permettent aux clients d'obtenir de l'aide, de maitriser, de mettre à jour et de personnaliser le logiciel.</p>
</CENTER> 
<div class="container"> 
<div class="row" style="margin-bottom: 50px;" id="block_r_r">
    <div id="block" style="width: 175px; height: 175px; background-color: #C50E1F; border-radius: 2px;margin-right: 50px;"> </div>
<div class="col-md">
    <h1>Développement spécifique</h1> 
    <h2>Pour répondre aux besoins spécifiques de ses clients, Adjustem propose ses services de développement.</h2>
 <ul id="Engagement">
    <li>Ajout de fonctionnalités.</li>
    <li>Création d'export de données personalisé.</li>
    <li>Création de rapports personnalisés.</li>
    <li>Création de tableau de bord personnalisé.</li>
 </ul> 
 </div>
</div>
<div class="row" style="margin-bottom: 50px;" id="block_r_p">
    <div id="block" style="width: 175px; height: 175px; background-color: #F8C39C; border-radius: 2px;margin-right: 50px;"> </div>
    <div  class="col-md">
        <h1>Engagement</h1> 
        <h2>Pour optimiser la fiabilité et l'utilisation du logiciel, la saisie des tarifs, leurs mises à jour et les évolutions sont à notre charge.
        </h2>
     </div>
    </div>
<div class="row" style="margin-bottom: 50px;" id="block_r_lo">
    <div id="block" style="width: 175px; height: 175px; background-color: #F6AD6E; border-radius: 2px;margin-right: 50px;"> </div>
    <div class="col-md">
        <h1>Formation</h1> 
        <h2>Adjustem exerce en qualité de prestataire de formation professionnelle.</h2>
    <p id="Support">La formation a pour objectif de former le personnel en charge du chiffrage de menuiseries à élaborer des devis avec l'aide du logiciel Adjustem.
    </p>
     </div>
    </div>
        <div class="row" style="margin-bottom: 100px;" id="block_r_o">
            <div id="block" style="width: 175px; height: 175px; background-color: #EE7F00; border-radius: 2px;margin-right: 50px;"> </div>
            <div class="col-md">
                <h1>Support technique (paramétrage logiciel)</h1> 
                <h2>Les services d'assistance sont réalisés par nos techniciens dans nos locaux.</h2>
        <p>Les services techniques s'appuient sur des outils tels que le téléphone,<br> le courrier électronique, les logiciels de prise en main à distance. (Télémaintenance)</p>
             </div>
            </div>
</div>
