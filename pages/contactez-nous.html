...
<head>
    ...
    <title>Adjustem - Solution de devis menuiseries - Contactez-nous</title>
</head>
<body class="overlay">
<div id="tt">
...
<CENTER>    
    <p id="p_title">Nous sommes à votre écoute pour répondre à vos questions.
    </p>
</CENTER>   
  <CENTER>  
        <div><img src="../images/contact.jpg" alt="" style="width: 1000px;height: 450px;object-fit: cover;box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.048);"></div>
    </center>
    <div id="form_ttl">
    <div id="form_ttl_s">Contactez-nous</div>
</div>
    <div class="container-fluid">
                <div class="row justify-content-center" style="margin-bottom: 50px; ">
                    ...
                    <div id="form" class=" col-xl-6 mx-auto " style="background-color: #ffffff;padding: 50px;box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.048);margin-top: -250px;" >
                        ...
                        <form action="">
                        <h1>Information</h1> 
                        <label for="" style="margin-right:20px;">Vous êtes:</label>
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div>
                            <label for="" style="margin-right:20px;">Civilité:</label>
                            <label for="M">M.</label>
