...
<head>
    ...
    <title>Adjustem - Solution de devis menuiseries - Demande de version d'essai</title>
</head>
<body class="overlay">
<div id="tt">
...
<CENTER>    
    <p id="p_title">Vous hésitez et voulez vérifier que notre logiciel correspond à votre besoin.Testez notre logiciel gratuitement
    </p>
</CENTER>   
  <CENTER>  
        <div><img src="../images/version_essai.jpg" alt="" style="width: 1000px;height: 450px;object-fit: cover;box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.048);"></div>
    </center>
    <div id="form_ttl">
    <div id="form_ttl_s">Demande de version d'essai
    ...
    <div class="container-fluid">
                <div class="row justify-content-center" style="margin-bottom: 50px; ">
                    ...
                    <div id="form" class=" col-xl-6 mx-auto " style="background-color: #ffffff;padding: 50px;box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.048);margin-top: -250px;" >
                       
                        <form action="">
                        <h1>Information</h1> 
                        <label for="">Vous êtes:&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                        <label for="Négoce">Négoce</label>
                        <input type="radio" id="Négoce" name="info">
                        <label for="Installateur">Installateur</label>
                        <input type="radio" id="Installateur" name="info">
                        <label for="Fabricant">Fabricant</label>
                        <input type="radio" id="Fabricant" name="info">
                        <label for="Artisan">Artisan</label>
                        <input type="radio" id="Artisan" name="info">
                        <div class="row" style="margin-top: 10px;">
                            <div>
                            <label for="">Civilité:&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                            <label for="M">M.</label>
                            <input type="radio" id="M" name="info">
                            <label for="Mme">Mme.</label>
                            <input type="radio" id="Mme" name="info">
                            <label for="Melle">Melle.</label>
                            <input type="radio" id="Melle" name="info">
                        </div>
                        </div>
                   
                        <div class="row">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Nom</p>
                                <input class="input_txt" type="text">
                            </div>
                        </div>
                        <div class="row">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Prénom</p>
                                <input class="input_txt" type="text">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 50px;">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Société</p>
                                <input class="input_txt" type="text">
                            </div>
                        </div>
                        <h1>Coordonnées</h1> 
                        <div class="row">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Adresse</p>
                                <input class="input_txt" type="text">
                            </div>
                        </div>
                        <div class="row">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Code Postal:
                                </p>
                                <input class="input_txt" type="text">
                            </div>
                        </div>
                        <div class="row">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Ville:</p>
                                <input class="input_txt" type="text">
                            </div>
                        </div>
                        <div class="row">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Téléphone:</p>
                                <input class="input_txt" type="text">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 50px;">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >E-mail:</p>
                                <input class="input_txt" type="text">
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 50px;">
                            <div>
                                <label for="">Votre installation :&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                <label for="Monoposte">Monoposte</label>
                                <input type="radio" id="Monoposte" name="info">
                                <label for="Réseau normal">Réseau normal</label>
                                <input type="radio" id="Réseau normal" name="info">
                                <label for="TSE(citrix)">TSE(citrix)</label>
                                <input type="radio" id="TSE(citrix)" name="info">
                                <label for="Autre">Autre</label>
                                <input type="radio" id="Autre" name="info">
                        
                            </div>
                        </div>
                        <div class="row">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >La liste de vos fournisseurs:</p>
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 50px;">
                            <div>
                            ...
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Votre logiciel de gestion:                                </p>
                                <input class="input_txt" type="text">
                            </div>
                        ...
                        <div class="row">
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Objet de votre message</p>
                                <input class="input_txt" type="text">
                            </div>
                            <div>
                                <p style="margin-bottom: 0px;margin-top: 20px;" >Corps du message</p>
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 50px;">
                            <div>
