...
<head>
    ...
    <title>Adjustem - Solution de devis menuiseries - Demande de referencement</title>
</head>
<body class="overlay">
<div id="tt">
...
<CENTER>    
    <p id="p_title">Adjustem vous simplifie les devis en menuiserie.
    </p>
</CENTER>   
  <CENTER>  
        <div><img src="../images/referencement.jpg" alt="" style="width: 1000px;height: 450px;object-fit: cover;box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.048);"></div>
    </center>
    <div id="form_ttl">
    <div id="form_ttl_s">Référencement
    </div>
</div>
