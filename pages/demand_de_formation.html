...
<head>
    ...
    <title>Adjustem - Solution de devis menuiseries - Demand de formation</title>
</head>
<body class="overlay">
<div id="tt">
...
<CENTER>    
    <p id="p_title">Adjustem vous propose des formations pour travailler efficacement.
    </p>
</CENTER>   
  <CENTER>  
        <div><img src="../images/formation_media.jpg" alt="" style="width: 1000px;height: 450px;object-fit: cover;box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.048);"></div>
    </center>
    <div id="form_ttl">
    <div id="form_ttl_s">Demande de formation
    </div>
</div>
    <div class="container-fluid">
                <div class="row justify-content-center" style="margin-bottom: 50px; ">
                    ...
                    <div id="form" class=" col-xl-6 mx-auto " style="background-color: #ffffff;padding: 50px;box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.048);margin-top: -250px;" >
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div>
                            <label for="">Choix de formation:&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                            <label for="Débutant">Débutant</label>
                            <input type="radio" id="Débutant" name="info">
                            <label for="Expert">Expert</label>
                            <input type="radio" id="Expert" name="info">
                            <label for="Sur-mesure">Sur-mesure</label>
                            <input type="radio" id="Sur-mesure" name="info">
                        </div>
                        </div>
                        <div class="row">
                            <div>
                        ...
                        <div class="row" style="margin-bottom: 50px;">
                            <div>
                                <label for="">Votre choix de format de formation:&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                <label for="locaux">Dans vos locaux</label>
                                <input type="radio" id="locaux" name="info">
                                <label for="distance">A distance</label>
                                <input type="radio" id="distance" name="info">
